      ...
      <div className="box-mid1-content">
        <div>
          <p>
            ...
            подсвеченное {!isMobile && <br />} специальным световым маячком зеленого цвета.
          </p>
          <p>
            Мы заботимся о вашем автомобиле.  На территории Open Parking 
            установлены {!isMobile && <br />} камеры  видеонаблюдения, а также 
            осуществляется круглосуточная  охрана, {!isMobile && <br />} что
            гарантирует безопасность  вашего транспортного средства.
          </p>
        </div>
        <nav>
          <button
